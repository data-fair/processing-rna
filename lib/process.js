        ...
        if (source.includes('waldec')) {
          for (const line of lines) {
            ...
            const item = [
              ...
              adresseSiege.trim(),
              line[21].replace('_', ''),
              codeRegex(line[22].padStart(5, 0)),
              codeRegex(line[23].padStart(5, 0)),
              line[24],
              line[25],
              adresseGestion.trim(),
              line[29],
              codeRegex(line[30].padStart(5, 0)),
              line[31],
              line[32],
              line[33],
              line[34],
          ...
          for (const line of lines) {
            ...
            const item = [
              ...
              adresseSiege.trim(),
              '',
              codeRegex(line[17].padStart(5, 0)),
              codeRegex(line[15].padStart(5, 0)),
              line[16],
              '',
              '',
              '',
